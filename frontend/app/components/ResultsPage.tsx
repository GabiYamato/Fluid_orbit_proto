            ...
            <div className="relative">
              ...
              {showSharePopup && (
                <motion.div 
                  ...
                  className="absolute right-0 top-full mt-4 w-64 bg-white/30 dark:bg-black/60 backdrop-blur-2xl border border-white/20 dark:border-white/10 rounded-3xl shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] p-4 z-50 text-black dark:text-white"
                >
                    {/* Copy Link */}
                    <button 
                        onClick={() => {
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        {/* Select Conversation */}
                         <button className="flex items-center justify-between p-3 rounded-2xl bg-white/10 hover:bg-white/20 transition-colors text-gray-700 dark:text-gray-200 border border-white/5">
